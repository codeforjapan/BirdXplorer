...
def write_media_csv(postgresql: Session) -> None:
    ...
    import warnings
    warnings.warn(
        "write_media_csv is deprecated. Use DataTransformerComponent instead.",
        DeprecationWarning,
        stacklevel=2
    )
    
    # Import the legacy implementation
    from birdxplorer_etl.legacy.transform import write_media_csv as legacy_write_media_csv
...
def generate_post_link(postgresql: Session):
    ...
    import warnings
    warnings.warn(
        "generate_post_link is deprecated. Use DataTransformerComponent instead.",
        DeprecationWarning,
        stacklevel=2
    )
    
    # Import the legacy implementation
    from birdxplorer_etl.legacy.transform import generate_post_link as legacy_generate_post_link
...
def generate_note_topic(sqlite: Session):
    ...
    import warnings
    warnings.warn(
        "generate_note_topic is deprecated. Use DataTransformerComponent instead.",
        DeprecationWarning,
        stacklevel=2
    )
    
    # Import the legacy implementation
    from birdxplorer_etl.legacy.transform import generate_note_topic as legacy_generate_note_topic
