...
class NoteExtractorComponent(PipelineComponent):
    ...
    def execute(self, context: PipelineContext) -> PipelineContext:
        ...
        try:
            ...
            self.logger.info(f"Community notes extraction completed successfully")
    ...
    def _extract_community_notes(self, sqlite: Session) -> None:
        ...
        while True:
            if (
                ...
                > datetime.timestamp(date) - 24 * 60 * 60 * days_ago
            ):
                break
    ...
    def _get_notes_url(self, date_string: str, use_dummy_data: bool) -> str:
        ...
        if use_dummy_data:
            return "https://raw.githubusercontent.com/codeforjapan/BirdXplorer/refs/heads/main/etl/data/notes_sample.tsv"
    ...
    def _get_note_status_url(self, date_string: str, use_dummy_data: bool) -> str:
        ...
        return f"https://ton.twimg.com/birdwatch-public-data/{date_string}/noteStatusHistory/noteStatusHistory-00000.tsv"
