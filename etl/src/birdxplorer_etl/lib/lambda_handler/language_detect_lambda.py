        ...
        if note_id:
            ...
            try:
                ...
                if settings.NOTE_TRANSFORM_QUEUE_URL:
                    ...
                    message_id = sqs_handler.send_message(
                        ...
                        message_body=note_transform_message
                    )
            ...
            return {
                ...
                'body': json.dumps({
                    ...
                    'summary_preview': note_row.summary[:100] + '...' if len(note_row.summary) > 100 else note_row.summary,
            ...
            return {
                'statusCode': 400,
                'body': json.dumps({
                    'error': 'Missing note_id in event or no valid language_detect message found'
                })
            }
